...
--------------------------------------------------
❤️Brought to You By @IgnitedNetwork || Made by @IgnitedCoder❤️**"""
...
async def my_event_handler(event):
    ...
    if "/gen" == event.raw_text.lower():
        ...
        if accounts:
            ...
            button = [
                [Button.url("Authentication error?", "https://t.me/IgnitedCoders")],
    ...
    if '/start' == event.raw_text.lower():
        button = [[(Button.url("Ignited Network", "https://t.me/IgnitedNetwork"))]]
